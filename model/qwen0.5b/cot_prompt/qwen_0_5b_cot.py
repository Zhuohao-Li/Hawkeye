...
model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen2.5-0.5B", device_map="auto")  # Automatically map to GPUs if possible
    ...
    with open(output_file, 'a', encoding='utf-8') as out_file:
        for idx, item in enumerate(tqdm(questions, desc="Processing questions")):
            ...
            system_prompt = (
                ...
                "using the chain of thought approach. We will provide you a reasoning chain as a hint. Please ensure your reasoning is clear and "
            ...
            outputs = model.generate(
                **inputs,
                max_new_tokens=1024,  # 仅限制生成文本的长度
            ...
            out_file.write(json.dumps({
                "index": idx + 1,
                "model_output": answer_text  # 仅保留生成的答案
            }, ensure_ascii=False) + "\n")
